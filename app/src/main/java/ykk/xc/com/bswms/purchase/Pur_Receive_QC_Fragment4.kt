...
import ykk.xc.com.bswms.purchase.adapter.Pur_Receive_QC_Fragment4_Adapter
    ...
    fun onEventBus(entity: EventBusEntity) {
        when (entity.caseId) {
            32 -> { // 接收第三个页面（32）发来的指令
                ...
                tv_num.text = Html.fromHtml("入库数:&nbsp;<font color='#FF0000'>"+ df.format(icstockBillEntry!!.fqty) +"</font>&nbsp;<font color='#666666'>"+ icstockBillEntry!!.unit.unitName +"</font>")
