...
import ykk.xc.com.bswms.basics.StockPos_DialogActivity
import ykk.xc.com.bswms.basics.Stock_DialogActivity
import ykk.xc.com.bswms.bean.*
import ykk.xc.com.bswms.bean.k3Bean.*
    ...
    fun onViewClicked(view: View) {
        when (view.id) {
            ...
            R.id.btn_sourceNoSel -> { // 选择来源单据
                ...
                bundle.putString("custName", parent!!.fragment1.icStockBill.supplier.fname)
            ...
            R.id.tv_batchNo -> { // 批次号
                showInputDialog("批次号", "", "none", RESULT_BATCH)
            }
            R.id.tv_unitSel -> { // 单位
//                val bundle = Bundle()
//                bundle.putString("accountType", "SC")
...
//        stockPos = null
    ...
    fun getICStockBillEntry(icEntry: ICStockBillEntry) {
        ...
        tv_mtlNumber.text = icEntry.icItem.fnumber
        tv_fmodel.text = icEntry.icItem.fmodel
